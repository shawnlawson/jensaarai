...
var AtomAdapter = function() {
  ...
  function AtomAdapter(atomInstance) {
    ...
    this.jensaarai = this.atom.packages.getActivePackage('jensaarai')
...
//two people only right now
    ...
    if (this.jensaarai.mainModule.recording !== undefined &&
        this.jensaarai.mainModule.recording !== null) {
      this.jensaarai.mainModule.recording.addOtherCursor(start, stop, reversed, color)
    }
  }
